...
pub fn run() {
    tauri::Builder::default()
        .invoke_handler(tauri::generate_handler![
            ...
            commands::ruleset::list_service_rules,
            commands::ruleset::list_all_service_rules,
            commands::ruleset::migrate_firewalld_zones,
            commands::ruleset::switch_firewalld_to_compat,
